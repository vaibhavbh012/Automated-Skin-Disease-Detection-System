...
const Login = () => {
    ...
    // On mount, check if there's a saved account to pre-fill
    useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data.success) {
                // Save these for future pre-filling as well
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center overflow-hidden bg-slate-900">
            ...
            >
                ...
                <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-cyan-500/10 rounded-full blur-[100px]"></div>
            ...
            >
                <div className="flex flex-col items-center mb-8">
                    ...
                    <p className="text-slate-400 text-center">Enter your details to access the AI Medical Dashboard</p>
                </div>
                ...
                <p className="mt-6 text-center text-sm text-slate-400">
                    ...
                    <Link to="/signup" className="text-cyan-400 hover:text-cyan-300 transition-colors font-medium">
                        Sign up taking less than a minute
                    </Link>
                </p>
            </motion.div>
        </div>
